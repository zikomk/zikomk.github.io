## Update modules with PyCharm:
Add this to Edit configuration / Parametars field where odoo.conf is:

    -u name_of_the_module --stop-after-init
...
## Update modules from command line:

"C:\Users\PC\AppData\Local\Programs\Python\Python37\python.exe" odoo-bin -d vit91 -u f4f_search -c ..\odoo.conf --stop-after-init

"C:\Users\PC\AppData\Local\Programs\Python\Python37\python.exe" odoo-bin -d vit91 -u f4f_search -c D:\vit14\odoo.conf --stop-after-init

python odoo-bin -d vit91 -u f4f_search -c D:\vit14\odoo.conf --stop-after-init
python odoo-bin --database=<db_name> --db_user=odoo --db_password=odoo --db_host=localhost --db_port=5432 INIT

python odoo-bin -d vit1 -u f4f_frontend_theme-c ..\odoo.conf --stop-after-init


    
## Uninstall modules from command line:

Run this command in your shell

    python3 odoo-bin shell -d mydb --addons-path=/your/addons/path

    "D:\odoo12092022\python\python.exe" odoo-bin shell -d odoo2 --addons-path=\\10.66.39.229\ProcatStageArea\f4fauth\f4f_addons
...
## Flags
see also:
http://vauxoo.github.io/odoo/reference/cmdline.html
